...
class Text(object): 
   ...
   TEXT60 = "http://www.eosgalaxy.io/vote?voter={0}&producers={1}&votenum={2}&producer={3}"
   TEXT61 = "addremind"
   ...
   TEXT72 = "http://www.eosgalaxy.io/transfer?transferor={0}&recipient={1}&quantity={2}&balance={3}&account={4}"
